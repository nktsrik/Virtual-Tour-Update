...
export default function AdminLokasiPage() {
  ...
  useEffect(() => {
    if (searchParams.get('action') === 'tambah') {
      router.push('/admin/lokasi/tambah');
    }
  }, [searchParams]);
  ...
  const loadKategori = async () => {
    try {
      ...
      const kategoriList = Array.isArray(response) ? response : (response.data || []);
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          onClick={() => router.push('/admin/lokasi/tambah')}
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  <span className="inline-flex items-center">
                    ...
                    Angka kecil akan tampil lebih dulu (0 = paling awal)
                  </span>
                </p>
              </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                  />
                  <p className="text-xs text-gray-500 mt-1">Nama singkat yang muncul saat hover marker di peta. Bebas diisi sesuai nama lokasi.</p>
                </div>
              </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-lg p-12 text-center">
          ...
          <button onClick={() => router.push('/admin/lokasi/tambah')}
                  ...
                  <tr key={item.id} className="hover:bg-green-50/30 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {item.deskripsi && (
                            <p className="text-xs text-gray-400 mt-0.5 line-clamp-1 max-w-xs">{item.deskripsi}</p>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => router.push(`/admin/lokasi/edit?id=${item.id}`)}
