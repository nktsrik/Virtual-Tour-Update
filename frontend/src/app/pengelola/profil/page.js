...
export default function ProfilPage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const profileData = {
        ...
        role_name: userData.role_name || 'Pengelola',
  ...
  const handleUpdate = async (e) => {
    ...
    if (profile.nama === originalProfile.nama && profile.email === originalProfile.email) {
      await Swal.fire({
        icon: 'info',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50 to-gray-50 p-8">
      <div className="max-w-5xl mx-auto">
        {/* Header with Avatar */}
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-green-500 to-green-600 shadow-xl mb-4">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-1">{profile.nama || 'Pengelola'}</h3>
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center">
                    <svg className="w-5 h-5 mr-3 text-gray-600 group-hover:text-green-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-sm font-medium text-gray-700 group-hover:text-green-600">Ubah Password</span>
                  </div>
                  <svg className="w-4 h-4 text-gray-400 group-hover:text-green-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 shadow-lg">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-semibold text-green-900 mb-2">💡 Tips Keamanan</h4>
              ...
              <div className="bg-gradient-to-r from-green-500 to-green-600 px-8 py-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-green-100 text-sm">Perbarui informasi pribadi Anda</p>
                  </div>
                  {!editMode && (
                    <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        className={`w-full px-4 py-3 border ${editMode ? 'border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent' : 'border-gray-200 bg-gray-50 cursor-not-allowed'} rounded-xl transition-all font-medium text-gray-900`}
                  ...
                  {editMode && (
                    <div className="pt-6 flex gap-3 border-t border-gray-100">
                      <button
                        type="submit"
                        disabled={updating}
                        className="flex-1 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-3.5 px-6 rounded-xl shadow-lg transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                      >
                        {updating ? (
