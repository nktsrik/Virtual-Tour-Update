...
function TambahLokasiPengelolaForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({ icon: 'error', title: 'Gagal', text: error.message || 'Terjadi kesalahan saat menyimpan data', confirmButtonColor: '#059669' });
    } finally {
      setLoading(false);
    }
  };
...
export default function PengelolaTambahLokasi() {
  return (
    <Suspense fallback={
